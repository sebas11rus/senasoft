    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_doc', models.CharField(choices=[('C.C', 'cedula de ciudadania'), ('T.I', 'tarjeta de identidad'), ('C.E', 'cedula extranjera')], max_length=20)),
                ('n_doc', models.IntegerField()),
                ('nom', models.CharField(max_length=30)),
                ('ape', models.CharField(max_length=50)),
                ('sexo', models.CharField(choices=[('H', 'Hombre'), ('F', 'Femenino'), ('IN', 'intersexual'), ('IND', 'Indifinido'), ('PRE', 'Prefiere no decir')], max_length=15)),
                ...
                ('accs_tec', models.CharField(choices=[('S', 'Si'), ('N', 'No')], default=True, max_length=30)),
                ('cuales', models.CharField(choices=[('M', 'Movil'), ('C', ' Computador'), ('T', 'Tablet'), ('O', 'Otro')], max_length=50)),
                ('con_int', models.BooleanField(choices=[('S', 'Si'), ('N', 'No')], default=True)),
                ('reg', models.CharField(choices=[('SUB', 'Subsidiado'), ('CON', 'Contributivo')], max_length=30)),
            ],
        ),
        migrations.CreateModel(
            name='Condicion',
